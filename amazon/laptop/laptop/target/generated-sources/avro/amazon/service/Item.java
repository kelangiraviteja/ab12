...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2126248860490316639L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"amazon.service\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"sku\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static amazon.service.Item.Builder newBuilder() {
    return new amazon.service.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static amazon.service.Item.Builder newBuilder(amazon.service.Item.Builder other) {
    if (other == null) {
      return new amazon.service.Item.Builder();
    } else {
      return new amazon.service.Item.Builder(other);
    }
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static amazon.service.Item.Builder newBuilder(amazon.service.Item other) {
    if (other == null) {
      return new amazon.service.Item.Builder();
    } else {
      return new amazon.service.Item.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(amazon.service.Item.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(amazon.service.Item other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder setSku(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder clearSku() {
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.Item.Builder clearQuantity() {
