...
public class OrderFailure extends org.apache.avro.specific.SpecificExceptionBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5223836515804809002L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"error\",\"name\":\"OrderFailure\",\"namespace\":\"amazon.service\",\"fields\":[{\"name\":\"message\",\"type\":\"string\"}]}");
   ...
   */
  public static amazon.service.OrderFailure.Builder newBuilder() {
    return new amazon.service.OrderFailure.Builder();
  }
   ...
   * @return A new OrderFailure RecordBuilder
   */
  public static amazon.service.OrderFailure.Builder newBuilder(amazon.service.OrderFailure.Builder other) {
    if (other == null) {
      return new amazon.service.OrderFailure.Builder();
    } else {
      return new amazon.service.OrderFailure.Builder(other);
    }
  }
   ...
   * @return A new OrderFailure RecordBuilder
   */
  public static amazon.service.OrderFailure.Builder newBuilder(amazon.service.OrderFailure other) {
    if (other == null) {
      return new amazon.service.OrderFailure.Builder();
    } else {
      return new amazon.service.OrderFailure.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificErrorBuilderBase<OrderFailure>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(amazon.service.OrderFailure.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(amazon.service.OrderFailure other) {
      super(other);
      if (isValidValue(fields()[0], other.message$)) {
        this.message$ = data().deepCopy(fields()[0].schema(), other.message$);
    ...
    @Override
    public amazon.service.OrderFailure.Builder setValue(Object value) {
      super.setValue(value);
      return this;
    }

    @Override
    public amazon.service.OrderFailure.Builder clearValue() {
      super.clearValue();
      return this;
    }

    @Override
    public amazon.service.OrderFailure.Builder setCause(Throwable cause) {
      super.setCause(cause);
      return this;
    }

    @Override
    public amazon.service.OrderFailure.Builder clearCause() {
      super.clearCause();
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.OrderFailure.Builder setMessage$(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amazon.service.OrderFailure.Builder clearMessage$() {
      message$ = null;
